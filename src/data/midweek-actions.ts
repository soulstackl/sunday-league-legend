...
export const MIDWEEK_ACTIONS: MidweekAction[] = [
  {
    ...
    icon: '⚽',
    description: 'Turn up to training. Pete notices.',
  ...
  },
  {
    ...
    name: 'Hit the gym',
    icon: '💪',
    description: 'Solo session. Focus on your athletic capabilities.',
  ...
  },
  {
    ...
    effects: { managerTrust: -5, fatigue: 8, specialModifier: 'work-overtime' },
  ...
  },
  {
    ...
    icon: '👁️',
    description: "Scout Sunday's opponents. Gain a tactical edge.",
  ...
  },
  {
    ...
    icon: '🤝',
    description: 'Buy someone a pint and sort things out.',
    npcTarget: true,
  ...
  },
  {
    ...
    icon: '🎯',
    description: 'Extra work on dead balls. Penalties, free kicks.',
