...
export const ARENA_SCENARIOS: ArenaScenario[] = [
  ...
  // ============ HEADER ============
  {
    ...
    rarity: 'common', baseWeight: 6,
    setup: { ball: { fixedX: 200, fixedY: 140, z: 130, vy: 0.8, vz: -1.2 } },
  ...
  },
  {
    ...
    statKey: 'head', statLabel: 'HEAD',
    rarity: 'uncommon', baseWeight: 4,
    setup: { ball: { fixedX: 270, fixedY: 150, z: 140, vy: 0.6, vz: -1.0 } },
  ...
  },
  {
    ...
    setup: { ball: { fixedX: 200, fixedY: 145, z: 135, vy: 0.4, vz: -1.1 } },
  ...
  },
  {
    ...
    setup: { ball: { xRange: [155, 245], yRange: [355, 378] }, distanceBand: 'long',
  ...
  // ============ GOAL-LINE CLEARANCE (additional) ============
  {
    ...
    rarity: 'rare', baseWeight: 1,
    gates: { minStat: { head: 11 } },
    setup: { ball: { xRange: [175, 225], fixedY: 35, z: 20, vz: -0.9 } },
